...
This module is intentionally invisible: it does not replace the existing UI and
it does not render any recovery banners. It only keeps the authenticated session
available to browser tabs, reloads, and editor launch links in Streamlit Cloud.
"""
